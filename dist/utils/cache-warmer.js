 ...
 */
async function warmUpTechnologiesCache() {
    try {
 ...
 */
async function warmUpUpdatesCache() {
    try {
 ...
 */
async function warmUpOverviewsCache() {
    try {
 ...
 */
export function schedulePeriodicCacheRefresh(intervalMs = 30 * 60 * 1000) {
