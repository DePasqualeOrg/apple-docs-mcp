...
import { handleListWWDCVideos, handleSearchWWDCContent, handleGetWWDCVideo, handleGetWWDCCodeExamples, handleBrowseWWDCTopics, handleFindRelatedWWDCVideos, handleListWWDCYears, wwdcFreshnessNote, } from './wwdc/wwdc-handlers.js';
 ...
 */
async function wwdcToolResult(text) {
...
export const toolHandlers = {
    ...
    get_technology_overviews: async (args, server) => {
        ...
        return await server.getTechnologyOverviews(validatedArgs.category, validatedArgs.searchQuery, validatedArgs.includeSubcategories, validatedArgs.limit);
    },
